...
<body class="flex h-screen bg-[#080808] font-sans">
    ...
    <aside class="w-64 bg-[#080808] text-white flex flex-col p-5 shadow-lg border-r border-white/10">
        ...
        <div class="flex items-center gap-3 pt-[9px] px-8 pb-6 mb-5 border-b border-white/20 mx-2">
        ...
        <ul class="space-y-1 flex-1 mt-4">
            ...
            <li>
                <a href="#" class="flex items-center gap-3 py-2.5 px-4 rounded-lg bg-[#1a1a1a] text-white font-medium transition duration-200 border border-[#2a2a2a]">
    ...
    <main class="flex-1 p-8 pt-0 overflow-y-auto bg-gradient-glow">
        ...
        <div class="grid grid-cols-5 gap-4 mt-8">
            ...
            <div class="bg-[#151515] border border-white/10 rounded-2xl p-5 flex flex-col justify-between hover:border-[#C7FF3D]/50 transition cursor-pointer">
                ...
                <div>
                    <h2 class="text-3xl font-bold text-white mb-1">24</h2>
                    <p class="text-xs text-[#C7FF3D] font-medium">+2 this month</p>
                </div>
            </div>
            ...
            <div class="bg-[#151515] border border-white/10 rounded-2xl p-5 flex flex-col justify-between hover:border-[#C7FF3D]/50 transition cursor-pointer">
                ...
                <div>
                    <h2 class="text-3xl font-bold text-white mb-1">156</h2>
                    <p class="text-xs text-[#C7FF3D] font-medium">+14% vs last week</p>
                </div>
            </div>
            ...
            <div class="bg-[#151515] border border-white/10 rounded-2xl p-5 flex flex-col justify-between hover:border-[#C7FF3D]/50 transition cursor-pointer">
                ...
                <div>
                    <h2 class="text-3xl font-bold text-white mb-1">89</h2>
                    <p class="text-xs text-[#C7FF3D] font-medium">89/100 Complete</p>
                </div>
            </div>
            ...
            <div class="bg-[#151515] border border-white/10 rounded-2xl p-5 flex flex-col justify-between hover:border-red-500/50 transition cursor-pointer">
                ...
                <div>
                    <h2 class="text-3xl font-bold text-white mb-1">12</h2>
                    <p class="text-xs text-red-500 font-medium">+3 since yesterday</p>
                </div>
            </div>
            ...
            <div class="bg-[#151515] border border-white/10 rounded-2xl p-5 flex flex-col justify-between hover:border-[#C7FF3D]/50 transition cursor-pointer">
                ...
                <div>
                    <h2 class="text-3xl font-bold text-white mb-1">18</h2>
                    <p class="text-xs text-[#C7FF3D] font-medium">3 teams</p>
                </div>
            </div>
